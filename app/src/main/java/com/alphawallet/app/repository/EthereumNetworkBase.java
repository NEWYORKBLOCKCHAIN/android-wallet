...
import static com.alphawallet.ethereum.EthereumNetworkBase.NYC_ID;
...
public abstract class EthereumNetworkBase implements EthereumNetworkRepositoryType
{
    ...
    private static final String POLYGON_HOMEPAGE = "https://cryptowallet.mikodes.com";
...
//                    ARTIS_SIGMA1_RPC_URL, "https://explorer.sigma1.artis.network/api?"));
            put(NYC_ID, new NetworkInfo(C.NYC_NAME, C.NYC_SYMBOL,
                    "https://mainnet-rpc.nycoin.org/",
                    "https://nycoin.org/tx/", NYC_ID,
                    "https://mainnet-rpc.nycoin.org/", "https://nycoin.org/api?"));
    ...
    private static final LongSparseArray<Integer> chainLogos = new LongSparseArray<Integer>() {
        {
            ...
            put(NYC_ID, R.mipmap.ic_launcher_round);
