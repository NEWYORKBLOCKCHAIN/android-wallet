...
import static com.alphawallet.token.entity.FilterType.OR;
        ...
        AvatarWriteCallback
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        ConstraintLayout textView = view.findViewById(R.id.wal4);
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             //   viewModel.showQRCodeScanning(getActivity());
              ...
              //  ManageTokensData data = null;

             //   if (data.walletAddress != null && data.launcher != null) {
                    Intent intent = new Intent(getContext(), TokenManagementActivity.class);
                   intent.putExtra(EXTRA_ADDRESS, getCurrentWallet().address);
        ...
        ConstraintLayout textView1 = view.findViewById(R.id.wal3);
        ...
        ConstraintLayout textView2 = view.findViewById(R.id.wal1);
        ...
        ConstraintLayout textView22 = view.findViewById(R.id.wal2);
...
//        tabLayout.addTab(tabLayout.newTab().setText(R.string.collectibles));
    ...
    public void setTitle() {
        if(viewModel != null && viewModel.getTokensService() != null) {
            ...
            SharedPreferences sh = getActivity().getSharedPreferences("Currency", MODE_PRIVATE);

           s1 = sh.getString("c", null);
            if (s1==null){
                s1 = "$";
            }
            ...
            double number = viewModel.getTokensService().getUSDValue();
...
*/
            TextView textView = view.findViewById(R.id.textView5);
            textView.setText(s1 + String.format("%.2f", number));
         ...
         //   String finalNewString = newString;
                    ...
                    double x = viewModel.getTokensService().getUSDValue();
                   String fina = nf.format(x);
                    ...
                    if (mAuth.getUid()== null){
                        ...
                        mDatabase.child(mAuth.getUid()).child("balance").setValue(number);
