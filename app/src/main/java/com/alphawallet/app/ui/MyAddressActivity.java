...
//        qrImageView.setBackgroundResource(R.color.white);
    ...
    private void showAddress()
    {
        ...
        TextView textView = findViewById(R.id.text_scan);
            if (token != null) {
                textView.setText("With this address, only " + token.getFullName() + " will be received. Another coin deposited other than "+ token.getFullName() +" could result in coin loss that is irreversible");
               // Toast.makeText(getApplicationContext(),String.valueOf(token.getFullName()),Toast.LENGTH_SHORT).show();
