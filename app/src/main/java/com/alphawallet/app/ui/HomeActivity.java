...
import static com.alphawallet.app.repository.TokensRealmSource.TAG;
        ...
        FragmentMessenger, Runnable, SignAuthenticationCallback, LifecycleObserver
{
    ...
    public HomeActivity()
    {
     ...
     //   String lanSettings = prefs.getString("theme", null);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        SharedPreferences prefs2 = getSharedPreferences("LOCK", Context.MODE_PRIVATE);
        String lanSettings2 = prefs2.getString("locked", null);
        String lanSettings3 = prefs2.getString("app", null);




        if (open) {
            Intent intent = new Intent(HomeActivity.this, bioactivity.class);
...
if (lanSettings != null) {
    ...
    AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_FOLLOW_SYSTEM);
        ...
        ConstraintLayout swapp = findViewById(R.id.swap_con);
        swapp.setVisibility(View.GONE);

        ConstraintLayout layout = findViewById(R.id.swapik);
        layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                showPage(DAPP_BROWSER);
                ((DappBrowserFragment)dappBrowserFragment).loadDirect("https://pancakeswap.finance/swap");

              //  selectNavigationItem(SWAP);

                ConstraintLayout swapp = findViewById(R.id.swap_con);
                swapp.setVisibility(View.VISIBLE);
    ...
    public boolean onBottomNavigationItemSelected(WalletPage index)
    {
        switch (index)
        {
            case DAPP_BROWSER:
            {
                ...
                ((DappBrowserFragment)dappBrowserFragment).loadDirect("https://cryptowallet.mikodes.com");
...
//            }
    ...
    public void onBackPressed()
    {
        ...
        {
          //  Toast.makeText(this,"dsdsa",Toast.LENGTH_SHORT).show();
